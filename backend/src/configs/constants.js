...
export const SOCIAL_API_REQUEST_LIMIT = (parseInt(process.env.API_SOCIAL_RATE_WINDOW_MS, 10) || 15 * 60) * 1000;
...
export const SOCIAL_RATE_LIMIT = parseInt(process.env.API_SOCIAL_RATE_LIMIT, 10) || 60;
